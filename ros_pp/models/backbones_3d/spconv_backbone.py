...
from ros_pp.model_utils.spconv_utils import replace_feature, spconv
...
class VoxelResBackBone8x(nn.Module):
    ...
    def forward(self, voxel_features: torch.Tensor, voxel_coords: torch.Tensor):
        """
        Args:
            batch_dict:
                batch_size: int
        ...
        # for detection head
        # [200, 176, 5] -> [200, 176, 2]
        encoded_spconv_tensor = self.conv_out(x_conv4)
